          ...
          {selectedMobile && (
            <div style={{ marginTop: 20 }}>
              ...
              <div style={paymentFormStyle}>
                <h3 style={{ margin: "0 0 14px", fontSize: 28, fontWeight: 1000, color: "white", letterSpacing: 0.4 }}>💰 Receive Customer Payment</h3>
...
function CustomerStatementBox({ selectedCustomer, selectedPending, selectedMobile, selectedTotalBusiness, selectedCashReceived, selectedDiscount, selectedAlreadyArrears, selectedBalance, selectedCustomerPayments, activeRentals, returnedPendingRentals, tools }: any) {
  ...
  return (
    <div style={customerBoxStyle}>
      <div style={customerBoxHeaderStyle}>
        <div style={customerBoxHeaderTitleStyle}>💰 RECEIVE CUSTOMER PAYMENT</div>
        <div style={customerBoxHeaderSubStyle}>Customer payments, rental details, history and statements</div>
      </div>

      <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", padding: "4px 4px 0" }}>
        <div>
...
function SummaryPill({ label, value, tone, strong }: any) {
  ...
  return (
    <div style={{ ...summaryPillStyle, ...(styleMap[tone] || styleMap.blue), fontWeight: strong ? 1000 : 900 }}>
      <span style={{ fontSize: 17, fontWeight: 1000, textTransform: "uppercase", letterSpacing: 0.6, opacity: 0.95 }}>{label}</span>
      <strong style={{ fontSize: 42, lineHeight: 1, fontWeight: 1000 }}>₹{Number(value || 0).toFixed(0)}</strong>
    </div>
  );
}
...
const customerBoxStyle: CSSProperties = { border: "5px solid #2563eb", background: "linear-gradient(180deg, #eef4ff 0%, #ffffff 34%, #f8fbff 100%)", borderRadius: 26, padding: 18, boxShadow: "0 24px 70px rgba(37, 99, 235, 0.30), 0 0 0 6px rgba(37, 99, 235, 0.08)", marginTop: 18 };
const customerBoxHeaderStyle: CSSProperties = { margin: "-18px -18px 18px", padding: "18px 22px", borderRadius: "20px 20px 0 0", background: "linear-gradient(135deg, #7c3aed, #2563eb 55%, #0f2a5f)", color: "white", boxShadow: "inset 0 -1px 0 rgba(255,255,255,0.18)" };
const customerBoxHeaderTitleStyle: CSSProperties = { fontSize: 34, fontWeight: 1000, letterSpacing: 0.8, lineHeight: 1.05 };
const customerBoxHeaderSubStyle: CSSProperties = { marginTop: 5, fontSize: 15, fontWeight: 850, opacity: 0.9 };
...
const statementSummaryLineStyle: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(6, minmax(155px, 1fr))", gap: 14, marginTop: 16, paddingTop: 16, borderTop: "3px solid #dbeafe" };
const summaryPillStyle: CSSProperties = { display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "flex-start", gap: 9, border: "3px solid", borderRadius: 20, padding: "18px 20px", minHeight: 112, fontSize: 17, whiteSpace: "nowrap", boxShadow: "0 16px 34px rgba(15, 23, 42, 0.16)" };
const paymentHistoryBoxStyle: CSSProperties = { marginTop: 16, border: "4px solid #0ea5e9", background: "linear-gradient(180deg, #ffffff, #f0f9ff)", borderRadius: 22, padding: 16, boxShadow: "0 18px 42px rgba(14, 165, 233, 0.24)" };
const paymentHistoryTitleStyle: CSSProperties = { fontSize: 26, fontWeight: 1000, color: "#075985", marginBottom: 12, letterSpacing: 0.2 };
...
const paymentFormStyle: CSSProperties = { marginTop: 18, border: "5px solid #c4b5fd", borderRadius: 26, padding: 22, background: "linear-gradient(135deg, #6d28d9, #4f46e5 58%, #1d4ed8)", boxShadow: "0 24px 58px rgba(79, 70, 229, 0.42), 0 0 0 6px rgba(124, 58, 237, 0.10)" };
